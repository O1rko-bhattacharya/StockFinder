...
export const searchSymbol = async (query) => {
  const url = `${basePath}/search?q=${query}&token=cqm4mnhr01qoqqs7uv6gcqm4mnhr01qoqqs7uv70`;
...
export const fetchStockDetails = async (stockSymbol) => {
  const url = `${basePath}/stock/profile2?symbol=${stockSymbol}&token=cqm4mnhr01qoqqs7uv6gcqm4mnhr01qoqqs7uv70`;
  const response = await fetch(url);
...
export const fetchQuote = async (stockSymbol) => {
  const url = `${basePath}/quote?symbol=${stockSymbol}&token=cqm4mnhr01qoqqs7uv6gcqm4mnhr01qoqqs7uv70`;
  const response = await fetch(url);
...
export const fetchHistoricalData = async (StockSymbol
  ...
  const url = `https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol=${StockSymbol}&outputsize=compact&apikey=${API}`;
  const response = await fetch(url);
